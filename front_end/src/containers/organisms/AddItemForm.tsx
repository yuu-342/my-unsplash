...
const AddItemFrom:React.FC<Props> = ({ categories }) => {
    ...
    <div className='add-item-form'>
      <form className={`${classes.root} form-area`} noValidate autoComplete='off' onSubmit={onSubmit}>
        ...
        <Autocomplete
          ...
          className={classes.formItem}
          renderInput={(params) => <TextField {...params} id='outlined-basic' label="Category" variant="outlined" name='category' inputRef={register}
          />}
        />
